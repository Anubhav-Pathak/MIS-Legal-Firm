...
function postRead(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const worksheetPath = path_1.default.join(xlsxBasePath, user.company + ".xlsx");
...
function getFilter(req, res) {
    try {
        ...
        const worksheetPath = path_1.default.join(xlsxBasePath, (user === null || user === void 0 ? void 0 : user.company) + ".xlsx");
        const workbook = xlsx_1.default.readFile(worksheetPath);
        if (!workbook)
